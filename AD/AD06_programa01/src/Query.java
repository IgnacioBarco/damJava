...
public class Query {
  ...
  private static String directorioScriptsRoot =
          "resources\\Scripts\\";
    //directorio de scripts BD Tutorial
//   "C:\\qizx\\docs\\samples\\book_queries\\";
    //nombres de los scripts con consultas XQuery - ficheros .xq
  private static String[] scriptNombre = { 
      "Script1.xq",//num asig por tipo
      "Script2.xq",//nombre alumnos que tienen notas
      "Script3.xq",//nota media y numero de asignaturas de cada alumno
      "Script4.xq",//alumnos cursan A y viven en talavera
      "Script52.xq",//verirficar punto 5
      "Script62.xq",//verirficar punto 6
      "Script72.xq",//verirficar punto 7
      "Script82.xq"};//verirficar punto 8
  //Si cambias a la BD Tutorial, los scripts son {"7.xq", "8.xq"};

  private static String resultado="";
  
  public void consulta(int idConsulta)
    ...
    try {
      ...
      //for (int i = 0; i < scriptNombre.length; ++i) {
        ...
        scriptFile = new File(directorioScriptsRoot + scriptNombre[idConsulta]);
  ...
  private static void mostrarResultado(XMLSerializer serializer,
   ...
   //Si no es un nodo del árbol XML, escribe el resultado como cadena
    if (!result.isNode()) {
      System.out.println(result.getString());
            setResultado(resultado+result.getString()+"\n");
      return;
    }
   ...
   //El método XMLSerializer.serializeToString se utiliza para obtener la 
    ...
    System.out.println(xmlForm);
        setResultado(resultado+xmlForm+"\n"); 
  }
