...
public class Poner {
    ...
    //ruta del Grupo de bases de datos (Library Group):C:\dbxml
    ...
    private static String datosOrigenRoot = "resources\\ColeccionNotas\\";
    //array con nombres de las colecciones origen a importar
    private static String[] datosOrigenNombre
            = {"Alumnos", "Asignaturas", "Matriculas"};
    //filtro de extensiones de los ficheros (documentos) a importar: xml y xhtml
    private static String extensionFiltro = "xml";
