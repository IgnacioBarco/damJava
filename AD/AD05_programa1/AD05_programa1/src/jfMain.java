...
public class jfMain extends javax.swing.JFrame {
  ...
  String url = "jdbc:postgresql://localhost:5433/anaconda";
  
  //contraseña del usuario postgree para acceder a la base de datos anaconda
  String user="java";
  String passwd = "1234";
  ...
  private void insertar_Registros(Connection conn) throws SQLException {
    ...
    String consulta = 
            ...
            + "VALUES "
            + "(ROW(1,90,3,2,2,'PROMOTOR1'),"
            + " ROW('DIR1', 'Madrid', 'Madrid', '28051')), "
            
            + "(ROW(1,50,1,1,1,'PROMOTOR2'),"
            + " ROW('DIR2', 'Madrid', 'Madrid', '28022')), "
            
            + "(ROW(6,150,4,3,2,'PROMOTOR3'),"
            + " ROW('DIR3', 'Getafe', 'Madrid', '28027')), "
            
            + "(ROW(3,120,4,2,0,'PROMOTOR3'),"
            + " ROW('DIR4', 'Leganes', 'Madrid', '28030')), "
            
            + "(ROW(2,80,2,2,1,'PROMOTOR4'),"
            + " ROW('DIR5', 'Caceres', 'Caceres', '10001')), "
            
            + "(ROW(1,100,3,2,0,'PROMOTOR4'),"
            + " ROW('DIR6', 'Caceres', 'Caceres', '10003')), "
            
            + "(ROW(0,250,5,4,2,'PROMOTOR4'),"
            + " ROW('DIR7', 'Malpartida', 'Caceres', '10005')), "
            
            + "(ROW(0,150,4,3,0,'PROMOTOR5'),"
            + " ROW('DIR8', 'Arroyo de la luz', 'Caceres', '10007'));";
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  private void rellenar_JTable(Connection conn, Object ciudad) 
    ...
    if (ciudad != null) {
      ...
      String consulta = String.format("SELECT * FROM viviendas_nuevas "
              + "WHERE (ubicacion).ciudad='%s'", ciudad);
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Oferta de vivienda nueva en la ciudad de:");
